    ...
    return (
        <Container>
            ...
            <div className={styles.aboutContainer}>
                ...
                <p className={styles.aboutText}>Since the spreadsheet is no longer being updated, I am doing my best to pull data off the news API, so hopefully I can keep up with new units now!</p>
